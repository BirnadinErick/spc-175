...
<?php if (count($projects) <= 0): ?>
    <p>No projects have been suggested yet!</p>
<?php else: ?>
    <div hx-get="<?= $API . "projects" ?>" hx-trigger="every 600s throttle:5s" hx-swap="outerHTML"
         class="my-4 space-y-4 lg:space-y-0 lg:grid lg:grid-cols-2 xl:grid-cols-3 lg:gap-4">
        <?php foreach ($projects as $project): ?>
            <div class="bg-spc-bg-mid rounded-sm p-4 space-y-2">
                <a href="<?= '/projects/detail?pid=' . $project['id'] ?>">
                    <div class="mb-6">
                    ...
                    <div>
                        <div class="flex justify-start items-center space-x-3 text-spc-light/90">
                            ...
                            <p><?= numfmt_format_currency($currency_fmt, (float)$project['amount'], "EUR") ?>
                                estimated</p>
                        </div>
...
<!--                            </svg>-->
<!---->
<!--                            <p>--><?php //= $project['upvote'] ?><!-- Upvotes received</p>-->
<!--                        </div>-->
                    </div>
                </a></div>
        <?php endforeach; ?>
