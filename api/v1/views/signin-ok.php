...
<p>Now that you are registered, why not leave your first comment on one of our posts?</p>

  <div class="mt-8 space-y-4">
<div
  class="bg-gradient-to-br from-spc-sea to-spc-gold p-[3px] max-w-fit text-spc-light mt-3"
>
  <a href="/patrician-publications">
    <div
...
<div>
  <a href="/">
    <p class="text-sm underline underline-offset-2 font-sans">Go to home instead</p>
  </a>
</div>
</div>
